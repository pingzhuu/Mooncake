...
struct FileStorageConfig {
    ...
    // After PR#2529 promotion runs on independent worker threads, so the
    // default is 4 to match the drain batch size. Set to 0 to disable
    // async workers and fall back to the synchronous heartbeat path.
